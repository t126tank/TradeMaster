...
data = dict(
    ...
    data_path='data/algorithmic_trading/JP225',
    train_path='data/algorithmic_trading/JP225/train.csv',
    valid_path='data/algorithmic_trading/JP225/valid.csv',
    test_path='data/algorithmic_trading/JP225/test.csv',
    test_dynamic_path=
    'data/algorithmic_trading/JP225/Market_Dynamics_Model/JP225/test_labeled_slice_and_merge_model_3dynamics_minlength12_quantile_labeling.csv',
    tech_indicator_list=[
